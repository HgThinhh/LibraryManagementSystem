...
{
	partial class frmInDanhSachPhieuMuon
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.InDanhSachPhieuMuon1 = new WindowsFormsApp1.InDanhSachPhieuMuon();
			...
			this.guna2Panel1.Size = new System.Drawing.Size(1653, 116);
			...
			this.txtMa.PlaceholderText = "Nhập mã phiếu mượn muốn xuất danh sách...";
			...
			this.crystalReportViewer1.ReportSource = this.InDanhSachPhieuMuon1;
			this.crystalReportViewer1.Size = new System.Drawing.Size(1653, 528);
			this.crystalReportViewer1.TabIndex = 2;
			// 
			// frmInDanhSachPhieuMuon
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(9F, 20F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.BackColor = System.Drawing.Color.Black;
			this.ClientSize = new System.Drawing.Size(1653, 644);
			this.Controls.Add(this.crystalReportViewer1);
			this.Controls.Add(this.guna2Panel1);
			this.Name = "frmInDanhSachPhieuMuon";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "frmInDanhSachPhieuMuon";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmInDanhSachPhieuMuon_Load);
		...
		private InDanhSachPhieuMuon InDanhSachPhieuMuon1;
	}
}