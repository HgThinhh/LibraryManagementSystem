...
{
	partial class frmInDanhSachTheoNgonNgu
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.InDanhSachSachTheoNgonNgu1 = new WindowsFormsApp1.InDanhSachSachTheoNgonNgu();
			...
			this.guna2Panel1.Size = new System.Drawing.Size(1568, 116);
			...
			this.txtMa.PlaceholderText = "Nhập Tên Ngôn Ngữ....";
			...
			this.crystalReportViewer1.ReportSource = this.InDanhSachSachTheoNgonNgu1;
			this.crystalReportViewer1.Size = new System.Drawing.Size(1568, 334);
			this.crystalReportViewer1.TabIndex = 5;
			// 
			// frmInDanhSachTheoNgonNgu
			// 
			...
			this.Name = "frmInDanhSachTheoNgonNgu";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "frmInDanhSachTheoNgonNgu";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmInDanhSachTheoNgonNgu_Load);
		...
		private InDanhSachSachTheoNgonNgu InDanhSachSachTheoNgonNgu1;
	}
}