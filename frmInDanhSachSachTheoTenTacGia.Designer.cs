...
{
	partial class frmInDanhSachSachTheoTenTacGia
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.InDanhSachSachTheoTacGia1 = new WindowsFormsApp1.InDanhSachSachTheoTacGia();
			...
			this.guna2Panel1.Size = new System.Drawing.Size(1441, 116);
			...
			this.txtMa.PlaceholderText = "Nhập Tên Tác Giả...";
			...
			this.crystalReportViewer1.ReportSource = this.InDanhSachSachTheoTacGia1;
			this.crystalReportViewer1.Size = new System.Drawing.Size(1441, 382);
			this.crystalReportViewer1.TabIndex = 3;
			// 
			// frmInDanhSachSachTheoTenTacGia
			// 
			...
			this.Name = "frmInDanhSachSachTheoTenTacGia";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "frmInDanhSachSachTheoTenTacGia";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmInDanhSachSachTheoTenTacGia_Load);
		...
		private InDanhSachSachTheoTacGia InDanhSachSachTheoTacGia1;
	}
}